...
//listar usuários com formulários
export const listarUsuariosComFormulariosControl = async (req: Request, res: Response) => {
    try {
        const {id_admin} = req.params
        const listar = await listarUsuariosComFormularios(Number(id_admin))
