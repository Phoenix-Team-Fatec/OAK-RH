...
function EquipeAdmin() {
  ...
  const handleSaveEdit = () => {
    if (selectedTeam) {
      ...
      try {
        ...
        setTeams(
          teams.map((t) =>
            t.id === selectedTeam.id ? { ...t, name: newTeamName } : t
          )
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Typography sx={{ margin: 5 }} variant="h4" gutterBottom>
          Equipes Admin!
        </Typography>
        ...
        <Modal open={openAddModal} onClose={() => setOpenAddModal(false)}>
          <Box sx={{ ...modalStyles }}>
            ...
            />
            <Button variant="contained" sx={{ mt: 2 }} onClick={handleAddTeam}>
              Adicionar
            </Button>
          </Box>
        </Modal>
        ...
        <Modal open={openEditModal} onClose={() => setOpenEditModal(false)}>
          <Box sx={{ ...modalStyles }}>
            ...
            <TextField
              ...
              onChange={(e) => setNewTeamName(e.target.value)}
            />
            <Button variant="contained" sx={{ mt: 2 }} onClick={handleSaveEdit}>
              Salvar
            </Button>
          </Box>
        </Modal>
